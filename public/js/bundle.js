...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGlseWxvdmUiLCJhIjoiY2w4OTgwNjR4MDN1MDN1bXRvbDZlNWZsayJ9.soVymaAKHOX8SZpPiaFqew';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/hilylove/cl8acsc7b002t14ocp5tbsy3d',
    // style URL
    scrollZoom: false
  });
...
var updataSettings = /*#__PURE__*/function () {
  ...
  return function updataSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updataSettings = updataSettings;
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  (0, _updateSetting.updataSettings)({
    name: name,
    email: email
  }, 'data');
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSetting.updataSettings)({
